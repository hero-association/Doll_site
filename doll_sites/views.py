...
def member(request):
	...
	#ABTEST签名构造
	month_signature = make_signature(month_price,pay_type,redirect,order_id,month_order_info,notify_url)
	season_order_info = 'season_member'
	season_signature = make_signature(season_price,pay_type,redirect,order_id_season,season_order_info,notify_url)
	year_order_info = 'year_member'
	year_signature = make_signature(year_price,pay_type,redirect,order_id_year,year_order_info,notify_url)
