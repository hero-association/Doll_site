...
def photodetail(request,photoid):
	...
	redirect = 'https://www.alolita.com' + current_url + '?paid=true&item=single'
	order_info = photo_detail.id
	notify_url = 'https://www.alolita.com/payment_response'
...
def member(request):
	...
	month_redirect = 'https://www.alolita.com' + str(redirect_url) + '&item=' + month_order_info
	season_order_info = 'season_member'
	season_redirect = 'https://www.alolita.com' + str(redirect_url) + '&item=' + month_order_info
	year_order_info = 'year_member'
	year_redirect = 'https://www.alolita.com' + str(redirect_url) + '&item=' + month_order_info
