...
def photodetail(request,photoid):
	...
	redirect = 'http://test.alolita.net' + current_url + '?paid=true&item=single'
	order_info = photo_detail.id
	notify_url = 'http://test.alolita.net/payment_response'
...
def member(request):
	...
	month_redirect = 'http://test.alolita.net' + str(redirect_url) + '&item=' + month_order_info
	season_order_info = 'season_member'
	season_redirect = 'http://test.alolita.net' + str(redirect_url) + '&item=' + month_order_info
	year_order_info = 'year_member'
	year_redirect = 'http://test.alolita.net' + str(redirect_url) + '&item=' + month_order_info	
